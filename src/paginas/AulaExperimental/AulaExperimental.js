...
class AulaExperimental extends React.Component {
  ...
  handleSubmit(e) {
    ...
    axios
      .post("https://crossfitmk1.com.br/sendmail/mk1-experimental.php", data)
      ...
      <div className="container container-aula-experimental">
        ...
        {this.state.showModal && (
          <div className="modal-aula">
            <div className="modal-aula__conteudo">
              ...
              <p>
                Foi enviado para o seu e-mail informações sobre a aula, te
                aguardamos em breve!
              </p>
              <button
        ...
        <div className="container container--max">
          <div className="container-aula-experimental__conteudo">
            ...
            <h3>
              Preencha todos os campos e selecione um horário para agendar sua
              aula experimental na Crossfit MK-1.
            </h3>
              ...
              <Form.Row>
                ...
                <Form.Group as={Col} md="6">
                  ...
                  >
                    ...
                    <option value="Segunda-feira às 20h">
                      Segunda-feira às 20h
                    </option>
                    <option value="Terça-feira às 20h">
                      Terça-feira às 20h
                    </option>
                    <option value="Quarta-feira às 19h">
                      Quarta-feira às 19h
                    </option>
                    <option value="Sexta-feira às 10h">
                      Sexta-feira às 10h
                    </option>
                  </Form.Control>
                </Form.Group>
